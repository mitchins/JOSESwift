...
class ECCryptoTestCase: CryptoTestCase {
    ...
    func getSimpleHeader(with signingAlgorithm: String) -> String {
        plainTextSimpleHeader.replacingOccurrences(of: "<algorithm>", with: signingAlgorithm)
    }

    func getHeader(with signingAlgorithm: String) -> String {
        plainTextHeader.replacingOccurrences(of: "<algorithm>", with: signingAlgorithm)
    }
